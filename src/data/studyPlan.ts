      ...
      days: [
        {
          ...
          mustFinish: [
            ...
            { id: "d1-m4", text: "Get quizzed by Claude on today's C# basics", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 1 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/get-started-c-sharp-part-1/ (Modules 1-3)\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 1 material. I've attached my checklist screenshot and module links above. Cover variables, data types (string, int, bool, decimal), Console.WriteLine(), string formatting, and string interpolation. Prioritize code-writing questions — make me write actual C# code. Include debugging questions with broken code I need to fix. Build up to combo challenges that combine multiple concepts.\"\n\nAnswer from memory — no peeking at notes. If you get something wrong, that's the thing to review tomorrow." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d2-m7", text: "Get quizzed by Claude on C# foundations and VB.NET basics", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 2 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/get-started-c-sharp-part-1/ (Modules 4-6)\n- https://learn.microsoft.com/en-us/training/modules/csharp-if-elseif-else/\n- https://learn.microsoft.com/en-us/training/modules/csharp-evaluate-boolean-expressions/\n- https://learn.microsoft.com/en-us/training/modules/csharp-switch-case/\n- https://learn.microsoft.com/en-us/visualstudio/get-started/visual-basic/tutorial-console\n- https://learn.microsoft.com/en-us/shows/visual-basic-fundamentals-for-absolute-beginners/ (Episodes 1-4)\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 2 material. I've attached my checklist screenshot and module links above. Cover if/else statements, boolean expressions, switch statements, number operations, type casting, and the guided projects from C# Part 1. Also quiz me on VB.NET basics: Dim declarations, If/Then/End If, Select Case, and translating simple C# to VB.NET. Prioritize code-writing questions. Include debugging questions with broken code. Build up to combo challenges.\"\n\nThis covers everything from the full C# Part 1 path, the three decision logic modules, and your first VB.NET contact. You should be able to write basic programs from scratch by now." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d3-m4", text: "Get quizzed by Claude on SQL (SELECT, WHERE, JOIN)", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 3 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/get-started-querying-with-transact-sql/ (Modules 1-3)\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 3 material. I've attached my checklist screenshot and module links above. Cover SELECT statements, WHERE clauses, ORDER BY, and JOINs (INNER, LEFT, RIGHT, FULL, CROSS). Give me table structures and make me write actual SQL queries. Include debugging questions with broken SQL I need to fix. Build up to combo challenges that combine multiple clauses.\"\n\nSQL is best learned by writing it. Expect to write 5-8 queries from scratch." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d4-m4", text: "Get quizzed by Claude on SQL (subqueries, GROUP BY, CRUD)", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 4 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/get-started-querying-with-transact-sql/ (Modules 4-6)\n- https://learn.microsoft.com/en-us/training/modules/create-stored-procedures-table-valued-functions/\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 4 material. I've attached my checklist screenshot and module links above. Cover subqueries, GROUP BY with aggregate functions (COUNT, SUM, AVG), HAVING, INSERT, UPDATE, DELETE, and stored procedures. Give me table schemas and make me write the SQL. Include debugging questions with broken queries. Build up to combo challenges that combine GROUP BY with WHERE and HAVING.\"\n\nYou should be able to write any basic CRUD SQL statement from memory now." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d5-m4", text: "Get quizzed by Claude on ASP.NET Core and Blazor", hours: 0.75, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 5 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/aspnet-core-web-app/ (all modules)\n- https://learn.microsoft.com/en-us/training/paths/build-web-apps-with-blazor/ (Modules 1-4)\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 5 material. I've attached my checklist screenshot and module links above. Cover what ASP.NET Core is, how Blazor relates to it, Blazor Server vs WebAssembly, what a .razor component is, data binding, and the component lifecycle. Prioritize code-writing questions — have me write small Blazor component snippets. Include debugging questions with broken Razor code. Build up to combo challenges.\"\n\nThis is a bigger quiz because you covered two frameworks today. Take your time." }
          ],
          niceToFinish: [
      ...
      days: [
        {
          ...
          mustFinish: [
            ...
            { id: "d7-m7", text: "Get quizzed by Claude on Blazor and EF Core setup", hours: 0.75, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 7 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/build-web-apps-with-blazor/ (Modules 5-8)\n- https://learn.microsoft.com/en-us/ef/core/get-started/overview/first-app\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 7 material. I've attached my checklist screenshot and module links above. Cover Blazor routing, forms and validation, reusable components, what a DbContext is, how to define model classes for EF Core, what a migration does, how to run migrations, and how to inject and use a DbContext in a Razor page. Prioritize code-writing questions — make me write Blazor and EF Core code. Include debugging questions with broken code. Build up to combo challenges.\"\n\nThis is where theory meets practice — you should be able to explain how your actual project is wired together." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d8-m7", text: "Get quizzed by Claude on full CRUD implementation", hours: 1, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 8 checklist. Today's work was project-based (no external course modules), so share what you built instead — describe your CRUD pages or share code snippets.\n\nClaude will quiz you based on what you built today. Suggested prompt:\n\"Quiz me on Day 8 material. I've attached my checklist screenshot above. Cover building a full CRUD app with Blazor Server and EF Core: displaying a list from the database, building a create form, editing an existing record, deleting a record, wiring up a dropdown from a related table, data annotations for validation, and how SaveChangesAsync works. Prioritize code-writing questions — make me write Blazor/C# code from scratch. Include debugging questions with broken CRUD code. Build up to combo challenges.\"\n\nThis is the most important quiz of the plan. If you can explain CRUD flows clearly, you can explain them in an interview." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d9-m4", text: "Get quizzed by Claude on OOP and VB.NET", hours: 0.75, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 9 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/implement-classes-properties-and-methods/\n- https://learn.microsoft.com/en-us/dotnet/visual-basic/programming-guide/language-features/\n- https://learn.microsoft.com/en-us/dotnet/visual-basic/programming-guide/language-features/objects-and-classes/walkthrough-defining-classes\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 9 material. I've attached my checklist screenshot and module links above. Cover OOP in C#: classes vs objects, properties, methods, constructors, access modifiers, encapsulation, and inheritance. Make me write class definitions from scratch. Also quiz me on VB.NET: Dim declarations, Sub vs Function, If/Then/End If, Select Case, For/Next, Public Class/End Class. Give me C# code and make me rewrite it in VB.NET. Include debugging questions with broken code in both languages. Build up to combo challenges.\"\n\nOOP is conceptually dense and VB.NET translation takes practice — expect to think hard on these." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d10-m5", text: "Get quizzed by Claude on EF Core and LINQ", hours: 0.75, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 10 checklist, and (2) the links to the docs you worked through today:\n- https://learn.microsoft.com/en-us/ef/core/ (Relationships, Querying, Saving Data, Migrations sections)\n\nClaude will read through the actual content before quizzing you. Suggested prompt:\n\"Quiz me on Day 10 material. I've attached my checklist screenshot and module links above. Cover EF Core and LINQ: how EF Core maps models to tables, relationships (one-to-many), navigation properties, .Where(), .OrderBy(), .Include(), .Select(), change tracking, SaveChangesAsync, and migrations. Give me scenarios and make me write LINQ queries from scratch. Include debugging questions with broken queries. Build up to combo challenges that chain multiple LINQ methods.\"\n\nLINQ is the bridge between your C# code and the database — nail this and EF Core makes sense." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d11-m6", text: "Get quizzed by Claude on debugging, API concepts, and VB.NET debugging", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 11 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/modules/dotnet-debug-visual-studio/\n- https://learn.microsoft.com/en-us/training/modules/build-web-api-aspnet-core/\n- https://learn.microsoft.com/en-us/visualstudio/get-started/visual-basic/tutorial-debugger\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 11 material. I've attached my checklist screenshot and module links above. Cover debugging in Visual Studio: breakpoints, stepping (F10/F11), watch window, inspecting variables. Cover REST API concepts: HTTP methods, controllers, when to add an API layer. Show me buggy C# code and have me find the issues. Also show me buggy VB.NET code — test my ability to debug in both languages. Build up to combo challenges.\"\n\nDebugging is a skill interviewers love to ask about — be ready to explain your process in both C# and VB.NET." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d12-m6", text: "Get quizzed by Claude on Git fundamentals", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 12 checklist, and (2) the links to the modules you finished today:\n- https://learn.microsoft.com/en-us/training/paths/github-foundations/ (first half)\n\nClaude will read through the actual module content before quizzing you. Suggested prompt:\n\"Quiz me on Day 12 material. I've attached my checklist screenshot and module links above. Cover Git and GitHub fundamentals: git init, git add, git commit, git push, git pull, branches, merging, what a remote is, what a README should contain, and the basic Git workflow. Make me write out the git commands for common scenarios. Include debugging questions — show me a broken Git workflow and have me fix it. Build up to combo challenges.\"\n\nGit is mostly conceptual — focus on knowing the commands and when to use them." }
          ],
          niceToFinish: [
      ...
      days: [
        {
          ...
          mustFinish: [
            ...
            { id: "d14-m5", text: "Get quizzed by Claude on testing and edge cases", hours: 0.75, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 14 checklist. Today's work was project-based (hardening and edge case testing), so describe what you tested and fixed instead of sharing course links.\n\nClaude will quiz you based on testing and error handling concepts. Suggested prompt:\n\"Quiz me on Day 14 material. I've attached my checklist screenshot above. Cover testing and hardening a Blazor app: common edge cases (empty inputs, long strings, invalid IDs, cascade deletes), error handling with try/catch, null checks, input validation beyond data annotations, and defensive coding. Give me scenarios and ask what would happen and how I'd fix it. Include debugging questions with broken error handling code. Build up to combo challenges.\"\n\nThis quiz is about thinking defensively — what breaks, and how do you prevent it?" }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d15-m5", text: "Get quizzed by Claude on code review, clean code, and VB.NET", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 15 checklist, and (2) the links to what you worked through today:\n- https://learn.microsoft.com/en-us/dotnet/visual-basic/developing-apps/ (VB.NET console CRUD app reference)\n\nClaude will quiz you on code quality and your VB.NET work. Suggested prompt:\n\"Quiz me on Day 15 material. I've attached my checklist screenshot above. Cover code quality and clean code practices in C#: naming conventions, comments vs better names, readability, EF Core migration cleanup, code review skills, and common code smells. Show me messy code and have me refactor it. Also quiz me on VB.NET — show me buggy VB.NET and have me fix it. Test my ability to write and debug VB.NET from scratch. Build up to combo challenges.\"\n\nClean code is a skill that separates junior devs who just make things work from ones who make things maintainable." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d16-m8", text: "Mock interview quiz with Claude", hours: 1, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed Day 16 checklist, and (2) your GitHub repo link for the Work Order Tracker project so Claude has context on what you built.\n\nSuggested prompt:\n\"Conduct a mock technical interview with me for a junior Application Developer position at a county government. The role uses C#, VB.NET, SQL Server, ASP.NET Core, and Blazor. The team maintains legacy VB.NET code and builds new features in C#/Blazor. I built a Work Order Tracker using Blazor Server and EF Core, and I also built a VB.NET console CRUD app. Here's my repo: [your GitHub link]. Ask me 12-15 questions mixing: tell me about your project, explain a technical concept, how would you debug X, write a SQL query for Y, translate this C# code to VB.NET, and how would you approach maintaining legacy VB.NET code. Grade me honestly and give feedback after each answer.\"\n\nTreat this like the real thing. Answer out loud if you can, not just by typing. This is the culmination of everything." }
          ],
          niceToFinish: [
        ...
        },
        {
          ...
          niceToFinish: [
            ...
            { id: "d17-n5", text: "Get quizzed by Claude on your weakest area", hours: 0.5, isQuiz: true, detail: "Before starting, send Claude: (1) a screenshot of your completed checklist showing what you worked on during overflow days, and (2) links to any modules or docs you reviewed.\n\nSuggested prompt:\n\"Quiz me on [your weakest topic — C# basics, VB.NET, SQL, Blazor, EF Core, OOP, or debugging]. I've attached my checklist screenshot and module links above. I've been studying for 2+ weeks and this is the area I'm least confident in. Start easy and escalate. Prioritize code-writing questions. Include debugging questions with broken code. Focus on the gaps in my understanding. Build up to combo challenges.\"\n\nBe honest about what you don't know yet. These final days are for shoring up weaknesses, not reviewing strengths." },
