  ...
  weeks: [
    {
      ...
      days: [
        ...
        },
        {
          ...
          isRestDay: false,
          mustFinish: [
            { id: "d2-m1", text: "Complete C# Part 1, Modules 4-6", hours: 3, detail: "Module 4 covers number operations and type conversions. Module 5 covers methods — calling them and defining your own. Module 6 is about decision logic (if/else statements, switch statements, and boolean expressions).\nThese are the building blocks for every program. Take your time with methods especially — understanding how to break code into smaller pieces is critical." },
            { id: "d2-m2", text: "Finish both guided projects (student grades + GPA calculator)", hours: 2.5, detail: "These are the capstone projects at the end of the C# Part 1 path. The student grades project has you build a program that calculates and displays student grades. The GPA calculator is similar but more complex.\nFollow the step-by-step instructions carefully. These combine everything from Modules 1-6 into real working programs. You should have working code at the end of each." },
            { id: "d2-m3", text: "Build one tiny extra console app yourself (tip calculator, unit converter, calorie counter — anything)", hours: 1.5, detail: "Pick something simple and build it from scratch. A tip calculator: ask for bill amount, ask for tip percentage, calculate and display the total. A unit converter: ask for a temperature in Fahrenheit, convert to Celsius.\nThe point is to write code without someone telling you what to type. It's okay if it's ugly — it just needs to work. Use Console.ReadLine() to get user input and Convert.ToInt32() or Convert.ToDouble() to convert it." },
            { id: "d2-m4", text: "Write 5-10 bullet-point recap from memory", hours: 0.5, detail: "Same as yesterday — close everything and write down what you learned. Focus on new concepts: methods, if/else, switch, type casting.\nTry to include at least one code snippet from memory, like how to write an if statement or how to define a method." },
            { id: "d2-m5", text: "Get quizzed by Claude on C# foundations", hours: 0.5, isQuiz: true, detail: "Open Claude and ask to be quizzed on Day 2 material. Suggested prompt:\n\"Quiz me on C# foundations: methods (defining and calling), if/else statements, switch statements, boolean expressions, type casting, and the math operations from Module 4. Make me write code, not just explain concepts.\"\nThis covers everything from the full C# Part 1 path. You should be able to write basic programs from scratch by now." }
          ],
          niceToFinish: [
      ...
      days: [
        {
          ...
          isRestDay: false,
          mustFinish: [
            { id: "d7-m1", text: "Complete Blazor, Modules 5-9 (Routing, Forms, JS interop, Razor class libs, Connect Four)", link: "https://learn.microsoft.com/en-us/training/paths/build-web-apps-with-blazor/", hours: 2.5, detail: "Finish the remaining Blazor modules. Module 5: routing (how URLs map to pages). Module 6: forms and validation. Module 7: JavaScript interop (calling JS from C#). Module 8: Razor class libraries (reusable components). Module 9: build a Connect Four game.\nModules 5-6 are the most important for your project. Modules 7-9 are good to know but less critical." },
        ...
        },
        {
          ...
          mustFinish: [
            ...
            { id: "d11-m6", text: "Get quizzed by Claude on debugging and API concepts", hours: 0.5, isQuiz: true, detail: "Open Claude and ask to be quizzed on Day 11 material. Suggested prompt:\n\"Quiz me on debugging in Visual Studio and REST API concepts. Cover: breakpoints, stepping through code (F10/F11), the watch window, inspecting variables, what a REST API is, HTTP methods (GET/POST/PUT/DELETE), what a controller does, and when you'd add an API layer. Show me buggy C# code and have me find the issues.\"\nDebugging is a skill interviewers love to ask about — be ready to explain your process." }
          ],
          niceToFinish: [
